...
if(found){
  printf("Found value for key A: %d\n", result);
}
else{
  printf("Didn't found value for key A\n");
}
ENDTEST
...
bst_print_tree(test_tree);
if(found){
  printf("Found value for key H: %d\n", result);
}
else{
  printf("Didn't found value for key H\n");
}
ENDTEST
...
bst_print_tree(test_tree);
if(found){
  printf("Found value for key X: %d\n", result);
}
else{
  printf("Didn't found value for key X\n");
}
ENDTEST
